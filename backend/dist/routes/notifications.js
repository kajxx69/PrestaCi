...
router.post('/test', async (req, res) => {
    try {
        const userId = req.userId;
        const notificationId = await InAppNotificationService.createCustom(userId, '🧪 Notification de test', 'Ceci est une notification de test pour vérifier que le système fonctionne correctement.', 'info', { test: true, timestamp: new Date().toISOString() });
        if (notificationId) {

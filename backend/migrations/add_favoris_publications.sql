-- Migration pour ajouter la table favoris_publications
-- Date: 2025-10-05

-- Créer la table favoris_publications si elle n'existe pas
...
-- Vérifier que les autres tables de favoris existent aussi
